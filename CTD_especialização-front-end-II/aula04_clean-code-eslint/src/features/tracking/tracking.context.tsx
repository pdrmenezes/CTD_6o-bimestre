...
import { AmplitudeTrackingSoftware, FacebookTrackingSoftware, GoogleTrackingSoftware } from "./software";
...
export const TrackingProvider = ({ children }: { children: React.ReactNode }) => {
  const [trackingSoftwares] = useState([new AmplitudeLiskovTrackingSoftware(), new FacebookTrackingSoftware(), new GoogleTrackingSoftware()]);
